...
const avaxUsdtPair = "0xed8cbd9f0ce3c6986b22002f03c6475ceb7a6256";
const pid = 28;

describe("AVAX/USDT LP DegenBox Strategy", async () => {
  let snapshotId;
  ...
  before(async () => {
    ...
    await deployments.fixture(["AVAXUSDTStrategy"]);
    ...
    Strategy = await ethers.getContract("AVAXUSDTStrategy");
    ...
    LpToken = await ethers.getContractAt<IERC20>("ERC20Mock", avaxUsdtPair);
    ...
    const lpHolder = "0x7Fe69733f5A2B632527Eae2D6818548875eB140f";
