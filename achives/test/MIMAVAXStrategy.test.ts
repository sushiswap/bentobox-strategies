...
const mimAvaxPair = "0x781655d802670bbA3c89aeBaaEa59D3182fD755D";
const pid = 43; // MasterChefV2 AVAX/USDC pool id

describe("MIM/AVAX LP DegenBox Strategy", async () => {
  let snapshotId;
  ...
  before(async () => {
    ...
    await deployments.fixture(["AVAXMIMStrategy"]);
    ...
    Strategy = await ethers.getContract("AVAXMIMStrategy");
    ...
    LpToken = await ethers.getContractAt<IERC20>("ERC20Mock", mimAvaxPair);
    ...
    const lpHolder = "0x3E74a96138183081576C256AfeE02a416A7EC53A";
